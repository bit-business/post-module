...
class SkijasiPostTestSetup extends Command
{
    public static $PHPUNIT_XML_PATH = 'phpunit.xml';
    public static $SKIJASI_UNIT_TEST_PATHS = [
        './vendor/skijasi/post-module/tests/Unit',
    ];
    public static $SKIJASI_FEATURE_TEST_PATHS = [
        './vendor/skijasi/post-module/tests/Feature',
    ];
     ...
     * @var string
     */
    protected $signature = 'skijasi-post-test:setup';
