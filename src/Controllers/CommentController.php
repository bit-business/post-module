...
namespace NadzorServera\Skijasi\Module\Post\Controllers;
...
use NadzorServera\Skijasi\Module\Post\Models\Comment;
...
class CommentController extends Controller
{
    ...
    public function getCommentByPostSlug(Request $request)
    {
        try {
            $request->validate([
                'slug' => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Post,slug',
    ...
    public function add(Request $request)
    {
        ...
        try {
            if (Auth::check()) {
                $request->validate([
                    'post_id'   => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Post,id',
                    'parent_id' => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Comment,id',
                ...
                return ApiResponse::failed(__('skijasi_post::validation.auth.user_not_logged_in'));
            }
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function read(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Comment',
            ]);
    ...
    public function edit(Request $request)
    {
        ...
        try {
            $request->validate([
                'id'        => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Comment,id',
                'post_id'   => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Post,id',
                'parent_id' => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Comment,id',
                'content'   => 'required|string',
            ]);
