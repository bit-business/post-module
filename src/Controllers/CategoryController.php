...
class CategoryController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            $request->validate([
                ...
                'slug'       => 'required|string|max:255|unique:NadzorServera\Skijasi\Module\Post\Models\Category',
                'content'    => 'nullable|string',
                'parent_id'  => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Category,id',
            ]);
    ...
    public function read(Request $request)
    {
        try {
            $request->validate([
                'id'     => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Category',
    ...
    public function readBySlug(Request $request)
    {
        try {
            $request->validate([
                'slug'   => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Category',
                'except' => 'nullable|in:true,false',
            ]);
    ...
    public function edit(Request $request)
    {
        ...
        try {
            $request->validate([
                ...
                'title'      => 'required|string|max:255',
                'meta_title' => 'nullable|string|max:255',
                'slug'       => 'required|string|max:255|exists:NadzorServera\Skijasi\Module\Post\Models\Category,slug',
                'content'    => 'nullable|string',
                'parent_id'  => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Category,id',
            ]);
    ...
    public function delete(Request $request)
    {
        ...
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Category|string',
            ]);
