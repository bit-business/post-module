...
use NadzorServera\Skijasi\Module\Post\Helpers\GetData;
    ...
    public function browse(Request $request)
    {
        try {
            $request->validate([
                ...
                'category' => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Category,slug',
                'tag' => 'nullable|exists:NadzorServera\Skijasi\Module\Post\Models\Tag,slug',
...
public function read(Request $request)
{
    ...
    public function readBySlug(Request $request)
    {
        try {
            $request->validate([
                'slug' => 'required|exists:NadzorServera\Skijasi\Module\Post\Models\Post',
            ]);
    ...
    public function author(Request $request)
    {
        try {
            $request->validate([
                'username' => 'required|exists:NadzorServera\Skijasi\Models\User,username',
            ]);
