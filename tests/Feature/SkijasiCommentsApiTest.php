...
namespace NadzorServera\Skijasi\Module\Post\Tests\Feature;
...
class SkijasiCommentsApiTest extends TestCase
{
    public function test_add_comments()
    {
        ...
        $request_data = [
            ...
            'thumbnail' => 'https://skijasi-web.s3-ap-southeast-1.amazonaws.com/files/shares/1619582634819_skijasi.png',
        ];
